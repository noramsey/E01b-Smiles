...
arcade.draw_ellipse_filled(face_x + 30, face_y + 39, 15, 25, open_color.black)
arcade.draw_ellipse_filled(face_x + -30, face_y + 39, 15, 25, open_color.black)
arcade.draw_circle_filled(face_x + 34, face_y + 47, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + -26, face_y + 47, 3, open_color.gray_2)
